...
export default class AddDeleteItems extends React.Component {
  ...
  render() {
    return (
      ...
      <TextInput style={styles.textinput} placeholder="Cost per Item" 
      placeholderTextColor="black"
      underlineColorAndroid={'transparent'}
      ...
      <TextInput style={styles.textinput} placeholder="Left in Stock" 
      placeholderTextColor="black"
      underlineColorAndroid={'transparent'}
      value={this.state.left}
      onChange = {(e)=>this.setState({ left: e.nativeEvent.text})}/>
