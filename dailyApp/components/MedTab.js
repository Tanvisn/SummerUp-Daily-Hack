...
import { Ionicons, FontAwesome, Entypo, AntDesign, MaterialCommunityIcons } from '@expo/vector-icons';
...
function MedHomeStack({navigation}){
	...
	<MedHomeStk.Navigator>
		<MedHomeStk.Screen name="MedReminder" component={MedHome} options={{title: "Medicine Home Page", headerShown: true, 
			headerLeft: (props)=>(<TouchableOpacity onPress={()=>{navigation.navigate('Home')}}><AntDesign name="arrowleft" size={24} color="black" style={{marginLeft:15}}/>
				</TouchableOpacity>)}} />
